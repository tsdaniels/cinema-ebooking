            ...
            {!isEditing && (
              <div className="space-y-4">
                ...
                <div>
                  <label
                    htmlFor="email"
                    className="block bg-grey-200 text-sm font-medium text-gray-700"
                  >
                    Email (can&#39;t be changed){' '}
                  </label>
                  <p className="mt-1 block w-full p-2 border bg-gray-200 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    {email}
                  </p>
                </div>
